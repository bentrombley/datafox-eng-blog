		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<div id="content">
					<h1>XML Sitemap</h1>
					<p class="expl">
						Generated by <a href="https://jekyllrb.com/">Jekyll</a> with <a href="https://github.com/reatlat/jekyll-sitemap">jekyll-sitemap</a> template, this is an XML Sitemap, meant for consumption by search engines.<br/>
					...
					<xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
						...
						<p class="expl"><a href="{{ 'sitemap.xml' | prepend: site.baseurl }}">&#8593; Sitemap Index</a></p>
						<table id="sitemap" cellpadding="3">
							<thead>
								<tr>
